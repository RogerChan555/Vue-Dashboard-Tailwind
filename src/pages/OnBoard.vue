  ...
  >
    <div class="onboard">
      ...
      <div class="mt-12" ref="parentElement">
        <div
          v-for="item in onboards"
          :key="item.id"
          :data-target="item.dataTarget"
          class="items-center ml-0 mb-5 lg:mb-12 effort-item-container"
        >
          <EffortItem
            :e-icon-url="item.eIconUrl"
            :effort-title="item.effortTitle"
            :effort-description="item.effortDescription"
          >
          </EffortItem>
...
const onboard = gsap.timeline({
  scrollTrigger: { trigger: '.effort-onboard', toggleActions: 'play pause restart reset' }
})
