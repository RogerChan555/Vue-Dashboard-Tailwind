<template>
    <MainContainer>
        <div class="grid lg:grid-cols-2 justify-items-center lg:justify-items-start lg:gap-20 xl:gap-20 solution py-20 lg:py-40" id="key_features">
            <ImageItem url="@/assets/images/mobile-solution.svg" class-name="lg:hidden solution-image" img-class="w-[45rem]"/>
            <ImageItem url="@/assets/images/mobile-solution.svg" class-name="lg:block hidden solution-image" img-class="w-fit"/>
...
<script setup lang="ts">
    ...
    const solutions = [
        {
            iconUrl: '@/assets/images/mobile_friendly.svg',
        ...
        {
            iconUrl: '@/assets/images/flash_on.svg',
        ...
        {
            iconUrl: '@/assets/images/event.svg',
        ...
        {
            iconUrl: '@/assets/images/bar_chart.svg',
